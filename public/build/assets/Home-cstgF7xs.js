import{u as j,j as e,H as N,r as c}from"./app-CNxo5WOs.js";import{u as M,L,l as f}from"./Layout-DDIQMnse.js";import"./react-CjZsb-BP.js";const _=[{title:"Webdesign",text:"Egyedi, modern és reszponzív design, ami kiemel a versenytársak közül.",icon:"M5 6h14v9H5z M9 19h6 M12 15v4 M15 4l5-2-2 5-8 8H8v-2l7-9z"},{title:"Webshop készítés",text:"Professzionális webshop WooCommerce vagy egyedi megoldásokkal.",icon:"M6 6h15l-2 8H8L6 3H3 M9 20h.01 M18 20h.01"},{title:"Webfejlesztés",text:"HTML, CSS, JavaScript, PHP és Laravel alapú fejlesztések.",icon:"M8 8 4 12l4 4 M16 8l4 4-4 4 M14 5l-4 14"},{title:"SEO & Marketing",text:"Keresőoptimalizálás és online marketing a jobb helyezésekért.",icon:"M12 3c3.2 1.2 5.2 3.5 6 7-3.5.8-5.8 2.8-7 6-3.2-1.2-5.2-3.5-6-7 3.5-.8 5.8-2.8 7-6z"},{title:"Online Marketing",text:"Célzott kampányok, Google Ads, Facebook és Instagram hirdetések.",icon:"M4 12h4l9-5v10l-9-5H4z M18 9c1.5 1.5 1.5 4.5 0 6"},{title:"Támogatás & Karbantartás",text:"Folyamatos támogatás, frissítések és biztonsági karbantartás.",icon:"M5 13a7 7 0 0 1 14 0v4a2 2 0 0 1-2 2h-2v-6h4 M5 13h4v6H7a2 2 0 0 1-2-2z"}],S=({path:t})=>e.jsx("svg",{className:"h-12 w-12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:t.split(" M").map((a,p)=>e.jsx("path",{d:p===0?a:`M${a}`},p))}),v=_.map(t=>t.icon),A=({words:t})=>{const a=c.useMemo(()=>t.filter(n=>typeof n=="string"&&n.trim().length>0),[t]),[p,w]=c.useState(0),[o,r]=c.useState(0),[s,x]=c.useState(!1);if(c.useEffect(()=>{if(a.length===0)return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){r(Array.from(a[0]).length);return}const g=Array.from(a[p]).length,m=!s&&o===g,z=s&&o===0,b=m?1250:z?260:s?46:78,h=window.setTimeout(()=>{if(m){x(!0);return}if(z){x(!1),w(l=>(l+1)%a.length);return}r(l=>l+(s?-1:1))},b);return()=>window.clearTimeout(h)},[s,o,a,p]),a.length===0)return null;const u=Array.from(a[p]).slice(0,o).join("");return e.jsxs("div",{className:"pz-home-typewriter","aria-live":"polite",children:[e.jsx("span",{className:"pz-home-typewriter__prompt","aria-hidden":"true",children:">"}),e.jsx("span",{className:"pz-home-typewriter__text",children:u}),e.jsx("span",{className:"pz-home-typewriter__cursor","aria-hidden":"true"})]})};function I(){const{locale:t,trans:a,t:p}=M(),{props:w}=j(),o=w?.localizedRoutes,r=a?.home??{},s=r.brand_label??"Progzone",x=Array.isArray(r.paragraphs)?r.paragraphs:[],u=Array.isArray(r.typewriter)?r.typewriter:["Webshop készítés","Weboldal készítés","Online marketing","Egyedi fejlesztés"],n=r.hero_title??{},g=r.hero_actions??{},m=Array.isArray(r.chips)?r.chips:["Modern design","Gyors betÃ¶ltÃ©s","MobilbarÃ¡t"],z=(Array.isArray(r.service_items)&&r.service_items.length>0?r.service_items:_).map((i,d)=>({...i,icon:v[d]??v[0]})),b=r.services_title??{},h=r.why??{},l=Array.isArray(h.items)?h.items:["Egyedi, igÃ©nyre szabott megoldÃ¡sok","Gyors Ã©s megbÃ­zhatÃ³ munkavÃ©gzÃ©s","Korrekt Ã¡rak, rejtett kÃ¶ltsÃ©gek nÃ©lkÃ¼l","TÃ¶bb Ã©ves tapasztalat","Teljes kÃ¶rÅ± Ã¼gyfÃ©ltÃ¡mogatÃ¡s"],y=typeof t=="string"&&t.toLowerCase().startsWith("de")?"pz-home-page pz-home-page--de":"pz-home-page",k=r.meta_title??p("menu.home","Home");return e.jsxs(L,{children:[e.jsx(N,{title:k}),e.jsx("style",{children:`
        :root {
          --pz-pink: #ff007a;
          --pz-cyan: #00f7ff;
          --pz-dark: #050812;
      ...
      `}),e.jsxs("main",{className:y,children:[e.jsxs("section",{className:"pz-home-hero",children:[e.jsxs("svg",{className:"pz-hero-light-trails",viewBox:"0 0 1440 660",preserveAspectRatio:"none","aria-hidden":"true",children:[e.jsx("path",{className:"pz-neon-path pz-cyan-stroke",d:"M-80 470 C 160 350, 290 415, 440 280 S 760 80, 1010 205 S 1260 420, 1520 285"}),e.jsx("path",{className:"pz-neon-path pz-pink-stroke",d:"M-60 565 C 170 480, 320 535, 505 382 S 790 190, 1010 302 S 1270 532, 1510 405"})]}),e.jsxs("svg",{className:"pz-hero-waves",viewBox:"0 0 1440 180",preserveAspectRatio:"none","aria-hidden":"true",children:[e.jsx("path",{className:"pz-neon-wave pz-cyan-stroke",d:"M-20 118 C 145 64, 280 164, 440 110 S 760 62, 920 106 S 1220 156, 1460 70"}),e.jsx("path",{className:"pz-neon-wave pz-pink-stroke",d:"M-20 145 C 190 88, 315 142, 505 124 S 790 164, 1010 96 S 1250 64, 1460 132"})]}),e.jsxs("div",{className:"pz-home-hero__inner",children:[e.jsxs("div",{children:[e.jsx("span",{className:"pz-neon-badge",children:s}),e.jsxs("h1",{className:"pz-home-hero__title",children:[e.jsx("span",{children:n.line1??"Weboldalkészítés"}),e.jsxs("span",{children:[n.line2_prefix??"és"," ",e.jsx("strong",{children:n.line2_highlight??"Online Megoldások"})]})]}),e.jsx(A,{words:u}),e.jsx("p",{className:"pz-home-hero__lead",children:x[0]??"Professzionális weboldal, webshop, webdesign és online marketing egy helyen."}),e.jsxs("div",{className:"pz-home-hero__actions",children:[e.jsxs("a",{href:f("quote",t,o),className:"pz-button",children:[g.quote??"Ingyenes árajánlat"," ",e.jsx("span",{"aria-hidden":"true",children:"→"})]}),e.jsxs("a",{href:f("contact",t,o),className:"pz-button pz-button-secondary",children:[g.contact??"Kapcsolat"," ",e.jsx("span",{"aria-hidden":"true",children:"→"})]})]}),e.jsx("div",{className:"pz-home-hero__chips",children:m.map((i,d)=>e.jsxs("div",{className:"pz-home-chip",children:[e.jsx("span",{className:d===1?"pz-home-chip__icon is-cyan":"pz-home-chip__icon",children:d===0?"↗":d===1?"◌":"▯"}),e.jsx("span",{children:i})]},i))})]}),e.jsxs("div",{className:"pz-home-hero__visual","aria-hidden":"true",children:[e.jsxs("svg",{className:"pz-hero-geometry",viewBox:"0 0 520 620",children:[e.jsx("path",{className:"pz-hero-geometry__stroke pz-hero-geometry__stroke--cyan",d:"M142 42 L492 156 L292 508 L406 566 L186 590 L260 452 L114 348 L238 232 Z"}),e.jsx("path",{className:"pz-hero-geometry__stroke pz-hero-geometry__stroke--pink",d:"M88 82 L456 188 L218 548 L70 392 L172 284 L72 216 Z"})]}),e.jsx("div",{className:"pz-home-portrait-frame",children:e.jsx("img",{src:"/img/me.png",alt:"",width:"1123",height:"1401",loading:"eager",decoding:"async",fetchPriority:"high",className:"pz-home-hero__portrait"})})]})]})]}),e.jsxs("section",{className:"pz-services",children:[e.jsxs("svg",{className:"pz-services-light",viewBox:"0 0 1440 760",preserveAspectRatio:"none","aria-hidden":"true",children:[e.jsx("path",{className:"pz-neon-path pz-pink-stroke",d:"M-80 690 C 190 610, 340 680, 530 535 S 860 315, 1090 390 S 1270 560, 1510 430"}),e.jsx("path",{className:"pz-neon-path pz-cyan-stroke",d:"M-60 560 C 180 430, 390 520, 590 330 S 930 135, 1170 230 S 1320 390, 1510 300"})]}),e.jsxs("div",{className:"pz-home-section",children:[e.jsxs("div",{className:"text-center mb-10",children:[e.jsxs("h2",{className:"text-4xl sm:text-5xl font-black tracking-[-0.04em]",children:[b.prefix??"Miben tudok"," ",e.jsx("span",{className:"pz-pink",children:b.highlight??"Neked segíteni?"})]}),e.jsx("span",{className:"mx-auto mt-5 block h-1 w-24 rounded-full bg-gradient-to-r from-[#ff007a] to-[#00f7ff] shadow-[0_0_18px_rgba(255,0,122,.8)]"})]}),e.jsx("div",{className:"pz-services-grid",children:z.map(i=>e.jsxs("article",{className:"pz-service-card",children:[e.jsx("div",{className:"pz-service-card__icon",children:e.jsx(S,{path:i.icon})}),e.jsx("h3",{children:i.title}),e.jsx("p",{children:i.text}),e.jsxs("a",{href:f("services",t,o),className:"pz-card-button",children:[r.details_label??"Részletek"," ",e.jsx("span",{children:"→"})]})]},i.title))}),e.jsxs("div",{className:"pz-why",children:[e.jsxs("div",{className:"pz-why-content",children:[e.jsx("span",{className:"pz-neon-badge",children:s}),e.jsxs("h2",{children:[h.title_prefix??"Miért válassz"," ",e.jsx("span",{className:"pz-pink",children:h.title_highlight??"Engem?"})]}),e.jsx("ul",{className:"pz-check-list",children:l.map(i=>e.jsxs("li",{children:[e.jsx("span",{className:"pz-check",children:"✓"}),e.jsx("span",{children:i})]},i))}),e.jsxs("a",{href:f("quote",t,o),className:"pz-button pz-button-secondary mt-7",children:[h.cta??"Árajánlatkérés"," ",e.jsx("span",{children:"→"})]})]}),e.jsxs("div",{className:"pz-devices","aria-hidden":"true",children:[e.jsx("div",{className:"pz-neon-tube"}),e.jsx("div",{className:"pz-neon-tube cyan"}),e.jsx("div",{className:"pz-glow-floor"}),e.jsx("img",{src:"/img/laptop.png",alt:"",width:"1858",height:"846",loading:"lazy",decoding:"async",className:"pz-laptop"})]})]})]})]})]})]})}export{I as default};
